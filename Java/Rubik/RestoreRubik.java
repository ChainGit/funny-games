...
public class RestoreRubik {
	...
	public static void main(String[] args) {
		...
		// 如果用这种方式就是录入魔方信息
		// rubik.getUpFace().init(Rubik.Yellow, Rubik.Yellow, Rubik.Yellow,
		// Rubik.Yellow, Rubik.Yellow,
		// Rubik.Yellow, Rubik.Yellow, Rubik.Yellow, Rubik.Yellow);
		// rubik.getFrontFace().init(Rubik.Blue, Rubik.Blue, Rubik.Blue, Rubik.Blue,
		// Rubik.Blue,
		// Rubik.Blue, Rubik.Blue, Rubik.Blue, Rubik.Blue);
		// rubik.getRightFace().init(Rubik.Red, Rubik.Red, Rubik.Red, Rubik.Red,
		// Rubik.Red,
		// Rubik.Red, Rubik.Red, Rubik.Red, Rubik.Red);
		// rubik.getBackFace().init(Rubik.Green, Rubik.Green, Rubik.Green, Rubik.Green,
		// Rubik.Green,
		// Rubik.Green, Rubik.Green, Rubik.Green, Rubik.Green);
		// rubik.getLeftFace().init(Rubik.Orange, Rubik.Orange, Rubik.Orange,
		// Rubik.Orange, Rubik.Orange,
		// Rubik.Orange, Rubik.Orange, Rubik.Orange, Rubik.Orange);
		// rubik.getDownFace().init(Rubik.White, Rubik.White, Rubik.White, Rubik.White,
		// Rubik.White,
