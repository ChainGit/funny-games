...
/**
 * Created by Jia en on 2015/11/14 0014.<br>
 * 
 * 魔方还原的算法<br>
 * Rubik getInstance() 获得Rubik的唯一实例<br>
 * void init() 初始化<br>
 * Face getFace().init() 初始化面的值,up,front,right,back,left,down<br>
 * String getDisruptedData() 获得打乱步骤的数据<br>
 * void handleTurn(String) 打乱魔方<br>
 * void cross() 运行cross<br>
 * void f2l() 运行f2l<br>
 * void oll() 运行oll<br>
 * void pll() 运行pll<br>
 * String getCrossData() 获得Cross的数据<br>
 * String getF2lData() 获得F2L的数据<br>
 * String getPllData() 获得PLL的数据<br>
 * String getOllData() 获得OLL的数据<br>
 * boolean isRubikFinished() 判断魔方是否复原<br>
 * 
 * 魔方的还原方法很多：层先法、角先法、棱先法、桥式方法、CFOP法等等。<br>
 * 初学者大都选者层先法，特点是公式少便于理解；竞速玩家一般是采用CFOP法，这种方法熟练之后可以在30秒之内将魔方的六面还原，下面就简单介绍下这种方法。<br>
 * CFOP方法一共分四步：CROSS→F2L→OLL→PLL<br>
 * CROSS：意思是底部打好十字<br>
 * F2L：（First two Layers) 意思是同时对好前两层<br>
 * OLL：（Orientation of last layer）意思是把顶层朝上的颜色统一<br>
 * PLL：（Permutation of last layer）意思是调整顶层顺序（完成整个魔方）<br>
 * 
 * https://github.com/JarenChow/SolveRubikByCFOP
 */
public class Rubik {
	...
	private boolean isContains3(int s) {
		return s == frontFace.getFiveStatus() || s == rightFace.getFiveStatus() || s == downFace.getFiveStatus();
	}
	...
	private boolean judgeOLL(int c1, int c2, int c3, int c4, int c5, int c6, int c7, int c8) {
		...
		return c1 == u5 && c2 == u5 && c3 == u5 && c4 == u5 && c5 == u5 && c6 == u5 && c7 == u5 && c8 == u5;
	}
	...
	private boolean run21PLL() {
		...
		int f2 = frontFace.getTwoStatus();
		int f3 = frontFace.getThreeStatus();
		if (r2 == l1 && l2 == f1 && f2 == r1 && is3Equals(b7, b8, b9) && is2Equals(l1, l3, l2) && is2Equals(r1, r3, r2)
				&& is2Equals(f1, f3, f2)) {
			pllData += "PLL_01M'M'U M U2M'U M'M'";
			return true;
		}
		if (r2 == f1 && f2 == l1 && l2 == r1 && is3Equals(b7, b8, b9) && is2Equals(l1, l3, l2) && is2Equals(r1, r3, r2)
				&& is2Equals(f1, f3, f2)) {
			pllData += "PLL_02M'M'U'M U2M'U'M'M'";
			return true;
		}
		if (b8 == f1 && f2 == b7 && l2 == r1 && r2 == l1 && is2Equals(b7, b9, b8) && is2Equals(l1, l3, l2)
				&& is2Equals(r1, r3, r2) && is2Equals(f1, f3, f2)) {
			pllData += "PLL_03M'M'U M'M'U U M'M'U M'M'";
			return true;
		}
		if (b8 == r1 && r2 == b7 && l2 == f1 && f2 == l1 && is2Equals(b7, b9, b8) && is2Equals(l1, l3, l2)
				&& is2Equals(r1, r3, r2) && is2Equals(f1, f3, f2)) {
			pllData += "PLL_04M'U M'M'U M'M'U M'U U M'M'U'";
			return true;
		}
		if (r3 == f2 && b9 == r2 && f3 == l2 && r1 == f2 && l3 == r2 && f1 == b8 && is2Equals(l1, l2, l3)
				&& is2Equals(b7, b8, b9)) {
			pllData += "PLL_05x'R R D D R'U'R D D R'U R'x ";
			return true;
		}
		if (b9 == f2 && r3 == l2 && l3 == f2 && f1 == r2 && f3 == r2 && r1 == b8 && is2Equals(l1, l2, l3)
				&& is2Equals(b7, b8, b9)) {
			pllData += "PLL_06x'R U'R D D R'U R D D R'R'x ";
			return true;
		}
		if (f3 == r2 && r1 == b8 && r3 == f2 && b9 == r2 && f1 == l2 && l3 == b8 && l1 == f2 && b7 == l2) {
			pllData += "PLL_07x'R U'R'D R U R'D'R U R'D R U'R'D'x ";
			return true;
		}
		if (is2Equals(l1, l3, l2) && is2Equals(b7, b8, b9) && is2Equals(f1, f2, f3) && r2 == l1 && r1 == b8 && r3 == f2
				&& l2 == f3 && l2 == b9) {
			pllData += "PLL_08R U R'U'R'F R2U'R'U'R U R'F'";
			return true;
		}
		if (is3Equals(l1, l2, l3) && f2 == b7 && b8 == f1 && f3 == r2 && r1 == b7 && r3 == f1 && b9 == r2) {
			pllData += "PLL_09R'U'F'R U R'U'R'F R2U'R'U'R U R'U R ";
			return true;
		}
		if (is2Equals(l2, l3, l1) && is2Equals(f1, f2, f3) && f3 == b9 && r1 == l2 && l1 == r3 && b7 == f2 && r2 == b9
				&& b8 == r3) {
			pllData += "PLL_10R'U R'd'R'F'R2U'R'U R'F R F ";
			return true;
		}
		if (is2Equals(f1, f2, f3) && is2Equals(r2, r3, r1) && f3 == b9 && r1 == l3 && l2 == b9 && b8 == l3) {
			pllData += "PLL_11F R U'R'U'R U R'F'R U R'U'R'F R F'";
			return true;
		}
		if (is3Equals(b7, b8, b9) && is2Equals(l1, l2, l3) && r2 == r1 && r2 == l3 && f1 == r3 && f2 == r3
				&& f3 == l2) {
			pllData += "PLL_12z U'R D'R2U R'U'R2U D R'z'";
			return true;
		}
		if (is3Equals(l1, l2, l3) && is2Equals(b7, b8, b9) && f2 == f3 && f2 == b9 && r1 == b8 && r2 == f1
				&& r3 == f1) {
			pllData += "PLL_13R U R'F'R U R'U'R'F R2U'R'U'";
			return true;
		}
		if (is2Equals(l2, l3, l1) && f2 == r1 && r2 == f1 && b9 == l2 && r3 == b8 && l1 == b8 && b7 == r1) {
			pllData += "PLL_14R'U2R U'U'R'F R U R'U'R'F'R2U'";
			return true;
		}
		if (is2Equals(f1, f2, f3) && l2 == b7 && b8 == l1 && b9 == r2 && r3 == f2 && r1 == b7 && f3 == r2) {
			pllData += "PLL_15R U'R'U'R U R D R'U'R D'R'U2R'U'";
			return true;
		}
		if (is2Equals(l1, l3, l2) && is2Equals(b8, b9, b7) && is3NotEquals(f1, f2, f3) && is3NotEquals(r1, r2, r3)) {
			pllData += "PLL_16R'R'u'R U'R U R'u R2f R'f'";
			return true;
		}
		if (is2Equals(l1, l3, l2) && is2Equals(r1, r2, r3) && is3NotEquals(b7, b8, b9) && is3NotEquals(f1, f2, f3)) {
			pllData += "PLL_17R U R'y'R2u'R U'R'U R'u R2";
			return true;
		}
		if (is2Equals(l1, l3, l2) && is2Equals(f2, f3, f1) && is3NotEquals(b7, b8, b9) && is3NotEquals(r1, r2, r3)) {
			pllData += "PLL_18R2u R'U R'U'R u'R'R'F'U F ";
			return true;
		}
		if (is2Equals(l1, l3, l2) && is2Equals(r2, r3, r1) && is3NotEquals(f1, f2, f3) && is3NotEquals(b7, b8, b9)) {
			pllData += "PLL_19R'd'F R2u R'U R U'R u'R'R'";
			return true;
		}
		if (is2Equals(f1, f2, f3) && is2Equals(b8, b9, b7) && l2 == r3 && r2 == l3 && b7 == f2 && l1 == r3 && f3 == b8
				&& r1 == l3) {
			pllData += "PLL_20R'U R U'R'F'U'F R U R'F R'F'R U'R ";
			return true;
		}
		if (is2Equals(b7, b8, b9) && is2Equals(f2, f3, f1) && l2 == r1 && r2 == l1 && l3 == r1 && f1 == b8 && r3 == l1
				&& b9 == f2) {
