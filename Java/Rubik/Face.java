...
public class Face {
	...
	public void init(int oneStatus, int twoStatus, int threeStatus, int fourStatus, int fiveStatus, int sixStatus,
			int sevenStatus, int eightStatus, int nineStatus) {
